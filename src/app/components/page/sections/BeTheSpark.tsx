...
import { ASSETS } from '@/app/constant/index.assets'
    ...
    return (
        <div className='container mx-auto px-4 bg-[#F5F7FA] flex items-center justify-center flex-col gap-4'>
            ...
            <div className='h-auto shadow-lg max-w-screen-lg aspect-video mx-auto rounded-2xl overflow-hidden'>
                <video src="https://d1m86avknwgx1f.cloudfront.net/videos/Ignite+Video+(2).mp4" controls autoPlay muted loop className='w-full h-full  object-contain aspect-video'></video>
            </div>
        </div>
    )
}
